            ...
            <div className="mb-44">
                ...
                <div className="grid grid-cols-6 mx-28">
                    <div className="col-span-1">
                        <img className="h-40 w-40 object-cover rounded-full mx-auto mb-3" src="/images/cherie.png" alt="cherie" />
                    ...
                    <div>
                        <img className="h-40 w-40 object-cover rounded-full mx-auto  mb-3" src="/images/michelle.jpg" alt="michelle" />
                    ...
                    <div>
                        <img className="h-40 w-40 object-cover rounded-full mx-auto mb-3" src="/images/von.jpg" alt="yvonne" />
                        <h1 className="text-grey-dark font-semibold tracking-wider text-md text-center">Yvonne Lim</h1>
                        <h1 className="text-grey-standard tracking-wider text-sm text-center">Full Stack Developer</h1>
                    </div>
                    <div>
                        <img className="h-40 w-40 object-cover rounded-full mx-auto mb-3" src="/images/daryl.jpg" alt="daryl" />
                        <h1 className="text-grey-dark font-semibold tracking-wider text-md text-center">Daryl Wong</h1>
                        <h1 className="text-grey-standard tracking-wider text-sm text-center">Full Stack Developer</h1>
                    </div>
                    <div>
                        <img className="h-40 w-40 object-cover rounded-full mx-auto mb-3" src="/images/boss.jpg" alt="boss" />
                        <h1 className="text-grey-dark font-semibold tracking-wider text-md text-center">Goh Wen Liang</h1>
                        <h1 className="text-grey-standard tracking-wider text-sm text-center">Full Stack Developer</h1>
                    </div>
                    <div>
                        <img className="h-40 w-40 object-cover rounded-full mx-auto mb-3" src="/images/yixuan.jpg" alt="yixuan" />
