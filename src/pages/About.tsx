            ...
            <div className="absolute z-10 px-3 overflow-hidden">
                <div className="grid md:grid-cols-7 gap-4 h-screen px-10 py-20 md:py-0">
                    <div className="border-1 md:col-span-4 md:pl-36">
                        ...
                        <h1 className="text-base text-grey-standard pr-10 pt-2">Here at FoodPrint, we support to F&B establishments in their journey towards food wastage reduction. We provide an innovative solution to help better manage food inventories, which would be especially helpful during this challenging times.</h1>
                    </div>
