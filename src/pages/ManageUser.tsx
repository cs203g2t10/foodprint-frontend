...
const ManageUser = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <button className="mr-16 mb-5 border px-4 py-1 bg-green-standard rounded-large shadow-sm hover:shadow-md text-white-standard flex ml-auto opacity-90 hover:opacity-100"
