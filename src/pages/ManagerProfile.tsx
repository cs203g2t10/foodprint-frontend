            ...
            {isAuthenticated && isAuthorized ? (
                <>
                    <div className="">
                        ...
                        <h1 className="text-lg text-black text-center text-grey-dark pb-8 bg-yellow-standard">What would you like to do today?</h1>
                        <div className="gap-y-2 m-10 rounded-xxl lg:mx-32 pb-10">
                            <div className="grid lg:grid-cols-3 justify-center items-center gap-x-16 mx-10 pt-10 gap-y-7">
                                ...
                                <Link to="/profile" className="bg-white-dirtyWhite rounded-xl shadow hover:shadow-md py-8">
