...
const ManageFood = (props: any) => {
    ...
    return (
        edit ?
            <div className="grid px-10 bg-white-dirtyWhite rounded-xl bg-white-standard shadow">
                <div className="h-32 w-32 mx-auto relative overflow-hidden rounded-full hover:shadow-md mt-4">
