...
const AdminRestaurantListing = (props: any) => {
    ...
    return (
        <div className="grid grid-cols-8 gap-x-6 mx-6  rounded-large py-2 px-4">
            ...
            <Link to={'/managerestaurant/' + restaurant.restaurantId} className="my-auto grid col-span-2 text-base border border-green-standard text-green-standard text-center h-8 rounded-lg opacity-90 shadow-sm hover:shadow-md hover:opacity-100">Manage Restaurant</Link>
            <Link to={'/manageingredients/' + restaurant.restaurantId} className="my-auto grid col-span-2 text-base border border-green-standard text-green-standard text-center h-8 rounded-lg opacity-90 shadow-sm hover:shadow-md hover:opacity-100">Manage Ingredients</Link>
        </div>
    )
}
