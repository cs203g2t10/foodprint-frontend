    ...
    return (
        <ReactModal style={customStyles} isOpen={deleteRestaurantModal} className="mt-10 focus:outline-none">
            <div className="grid justify-center items-center gap-y-2 rounded-lg shadow w-1/3 mx-auto pb-10 pt-6 mt-24 bg-white-standard relative">
                ...
                {
                    deleted ?
                        <div className="mx-16 grid gap-y-3">
                            <div className="text-green-standard">Restaurant with ID {props.restaurantId} has been deleted!</div>
                            <button className="text-white-standard py-1 rounded-lg shadow-md hover:shadow-lg border border-green-standard bg-green-standard text-center mx-10"
