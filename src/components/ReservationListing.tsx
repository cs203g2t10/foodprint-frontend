...
const ReservationListing = (props: any) => {
    ...
    return (
        <div className="grid grid-cols-12 mb-3 bg-white-standard p-2 rounded-large gap-x-3">
            ...
            <button className="text-white-standard text-xs mx-auto col-span-2 w-20 px-1 my-auto py-1 bg-green-standard rounded-large shadow-md hover:shadow-lg opacity-90 hover:opacity-100">View Order</button>
            <div> {
